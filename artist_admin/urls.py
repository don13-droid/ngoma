...
urlpatterns = [
    ...
    path('artist-contribs/', views.revenue_contribs, name='artist-contrib'),
    path(r'delete-song/(<pk>\w+)/', views.delete_song, name='delete_song'),
    path(r'single-song/(<pk>\w+)/', views.single_song, name='single_song'),
    ...
    path(r'user_payouts/(<id>\w+)/', views.Artist_Payments, name='payouts'),
